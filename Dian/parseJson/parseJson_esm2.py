...
# Path settings
txt_directory = r'F:\Dropbox\新建文件夹\Dropbox\2024\Cheng lab\PDB\propedia v2.3\txt files_test'
json_directory = r'F:\Dropbox\新建文件夹\Dropbox\2024\Cheng lab\PDB\propedia v2.3\json_test'
    ...
    with open(txt_filePath, 'r') as file:
        ...
        for line in file:
            ...
            if key not in pdb_dict[pdb_id]['combined_chains']:
                ...
                pdb_dict[pdb_id]['combined_chains'][key] = f"{' <eos> '.join(sequence[chain] for chain in chains_tuple if chain in sequence)}"
