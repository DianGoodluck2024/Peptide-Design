...
# Example usage
directory_path = r'F:\Dropbox\新建文件夹\Dropbox\2024\Cheng lab\PDB\propedia v2.3\json_esm2'  # Replace with your directory path
csv_file_path = r'F:\Dropbox\新建文件夹\Dropbox\2024\Cheng lab\PDB\propedia v2.3\annotation files\annotation_files_esm2.csv'  # Replace with your desired CSV file path
